...
int main()
{
    int menu, pedido, escolhaPizza, escolhaBebida, quantidadePizza, querBebida, querDoce, pagamento, cep, cpf , quantidadeBebida, quantidadeDoce , escolhaDoce;
    char email[50];
    char complemento[50];
    char nomePizza[50];
    char nomeBebida[50];
    ...
    case 1:
        ...
        printf("Quantas pizzas voc deseja? ");
        ...
        if (querBebida == 1)
        {
            ...
            {
            case 1:
                strcpy(nomeBebida, "Coca-Cola"); precoBebida = 12.0;
                break;
            case 2:
                strcpy(nomeBebida, "Guarana"); precoBebida = 11.0;
                break;
            case 3:
                strcpy(nomeBebida, "Suco de laranja"); precoBebida = 10.0;
                break;
            case 4:
                strcpy(nomeBebida, "Agua");precoBebida= 8.0;
                break;
            }
        }
        ...
        if (querDoce == 1)
        {
            ...
            {
            case 1:
                strcpy(nomeDoce, "Chocolate");precoDoce = 50.0;
                break;
            case 2:
                strcpy(nomeDoce, "Prestigio"); precoDoce = 55.0;
                break;
            case 3:
                strcpy(nomeDoce, "RomeuJulieta"); precoDoce = 55.0;
                break;
            case 4:
                strcpy(nomeDoce, "Brigadeiro"); precoDoce = 50.0;
                break;
            }
        }
